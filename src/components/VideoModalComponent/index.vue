...
<template>
  ...
  <div class="flex items-center flex-col">
    ...
    <div
      class="w-full max-[680px]: z-20 relative flex flex-col justify-center items-center"
    >
      <div
        ref="container"
        class="w-full max-w-[450px] rounded-3xl z-20 relative h-[300px] border-[20px] border-[#7A40E4] flex justify-around items-center bg-[#343434] mb-5"
      >
        <iframe
          width="450px"
          height="255"
    ...
    <div class="w-full max-w-[600px]">
      <form class="space-y-6 w-full max-w-[600px] m-auto">
